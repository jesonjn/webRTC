...
public class MainMenuFragment extends Fragment implements MediaEngineObserver {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		btSwitchCamera
				.setText(getEngine().frontCameraIsSet() ? R.string.backCamera
						: R.string.frontCamera);

		btStartStopCall = (Button) v.findViewById(R.id.btStartStopCall);
		btStartStopCall.setText(getEngine().isRunning() ? R.string.stopCall
				: R.string.startCall);
	...
	public void toggleStart() {
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				IceClient client = new IceClient(9999, "medio");
				try {
					client.init();
